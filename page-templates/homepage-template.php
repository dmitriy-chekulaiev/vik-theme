...
get_header(); ?>
    ...
    <div class="homepage homepage-content">
        <?php if (have_rows('homepage_content')):
            while (have_rows('homepage_content')) : the_row();
                ...
                if (get_row_layout() == 'fashion_section'):
                    ...
                    <section class="homepage__fashion-section fashion-section">
                ...
                <?php elseif (get_row_layout() == 'site_links_section'):
                    ...
                    <section class="homepage__links-section links-section">
                        <div class="container">
                            <div class="row mobile-slider">
                ...
                <?php elseif (get_row_layout() == 'blog_section'):
                    ...
                    <section class="homepage__blog-section blog-section">
                        <div class="container">
                            <div class="row mobile-slider">
                ...
                <?php elseif (get_row_layout() == 'testimonials_section'): ?>
                    <?php $testimonialsTitle = get_sub_field('title');
                    $testimonialsSectionRepeater = get_sub_field('testimonials'); ?>

                    <?php if ($testimonialsSectionRepeater) : ?>
                        <section class="homepage__testimonials-section testimonials-section">
                ...
                <?php elseif (get_row_layout() == 'home_banner_section'):
                    ...
                    <?php if ($bannerTitle) : ?>
                    <div class="homepage__banner-section banner-section">
                        <div class="container">
                ...
                <?php elseif (get_row_layout() == 'get_in_touch'):
                    ...
                    $formText = get_sub_field('text'); ?>
                    <?php if ($formText) : ?>
                    <section id="get-in-touch-form" class="homepage__form-section form-section">
                        <div class="container">
                            <div class="row">
                ...
                <?php elseif (get_row_layout() == 'title_and_text_section'):
                    ...
                    <section class="homepage__title-and-text-section title-and-text-section">
                        <div class="container">
                            <div class="row">
                ...
                <?php elseif (get_row_layout() == 'hosting_alternatives'):
                    ...
                    <section class="homepage__hosting-alternatives-section hosting-alternatives-section">
                        <div class="container">
                            <div class="row">
                ...
                <?php elseif (get_row_layout() == 'blocks_section'):
                    ...
                    <section class="homepage__blocks-section blocks-section">
                        <div class="container">
                            <div class="row">
                ...
                <?php elseif (get_row_layout() == 'accordion_section'):
                    ...
                    <section class="homepage__accordion-section accordion-section">
                        <div class="container">
                            <h3 class="headline">
                ...
                <?php elseif (get_row_layout() == 'hosting_alternatives_with_tabs'):
                    ...
                    <section
                            class="homepage__hosting-alternatives-section hosting-alternatives-section hosting-alternatives-section__with-tabs">
                        <?php $counter = 0; ?>
                ...
                <?php elseif (get_row_layout() == 'check_section'):
                    ...
                    <section class="homepage__checkboxes-section checkboxes-section">
                        <div class="container">
                ...
                <?php elseif (get_row_layout() == 'wysiwyg_editor_section'):
                    ...
                    <?php if ($content) : ?>
                    <section class="homepage__content-section content-section">
                        <div class="container">
                            <div class="row">
                                <?php echo $content; ?>
                            </div>

 ...
 */
if (!function_exists('vikings_site_scripts')) :
    function vikings_site_scripts()
    {
        ...
        wp_enqueue_script('parallax-js', get_template_directory_uri() . '/assets/scripts/parallax.js');
    ...
    add_action('wp_enqueue_scripts', 'vikings_site_scripts');
endif;

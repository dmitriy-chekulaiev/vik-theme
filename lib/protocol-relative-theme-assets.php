...
if ( ! class_exists( 'Vikings_site_Protocol_Relative_Theme_Assets' ) ) :
	class Vikings_site_Protocol_Relative_Theme_Assets {
		/**
	...
	$vikings_site_protocol_relative_theme_assets = new Vikings_site_Protocol_Relative_Theme_Assets;
endif;

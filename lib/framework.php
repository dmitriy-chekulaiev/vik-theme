...
/**
 * Various functions required for vikings_site-bootstrap to work properly
 *
 */
/*
 * Table of contests:
...
/**
 * 2 - Menu navigation walker
 * Class Name: vikings_site_navwalker
 * GitHub URI: https://github.com/twittem/wp-vikings_site-navwalker
 * Description: A custom WordPress nav walker class to implement the vikings_site 3 navigation style in a custom theme using the WordPress built in menu manager.
 */

class vikings_site_navwalker extends Walker_Nav_Menu {
...
/*
 * 3 - Pagination
 * Custom pagination with vikings_site .pagination class
 * source: http://www.ordinarycoder.com/paginate_links-class-ul-li-vikings_site/
 */
function vikings_site_pagination( $echo = true ) {
    global $wp_query;
...
/**
 * 4 - Comments tree
 * vikings_site Comments Tree
 *
 */
if ( ! class_exists( 'vikings_site_Comments' ) ) :
    class vikings_site_Comments extends Walker_Comment{
